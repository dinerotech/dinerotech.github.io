    ...
    >
      ...
      <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        <div>
          ...
          >
            {t.jobDetails.formSection.firstName}{" "}
        ...
        <div>
          <label
            ...
            className="block text-sm/6 font-semibold text-gray-900"
          >
            {t.jobDetails.formSection.lastName}{" "}
            <span className="text-red-600">*</span>
          </label>
          <div className="mt-2.5">
            <input
        ...
        <div>
          <label
            ...
            className="block text-sm/6 font-semibold text-gray-900"
          >
            {t.jobDetails.formSection.workEmail}{" "}
            <span className="text-red-600">*</span>
          </label>
          <div className="mt-2.5">
            <input
        ...
        <div>
          <label
            ...
            className="block text-sm/6 font-semibold text-gray-900"
          >
            {t.jobDetails.formSection.workPhone}
          </label>
          <div className="mt-2.5">
            <input
              type="tel"
        ...
        <div className="sm:col-span-2">
          <label
            ...
            className="block text-sm/6 font-semibold text-gray-900"
          >
            {t.jobDetails.formSection.resume}{" "}
            <span className="text-red-600">*</span>
          </label>
          <div className="mt-2.5">
            <input
          ...
          <p className="mt-1 text-sm text-gray-500">
            {t.jobDetails.formSection.resumeNote}
          </p>
        </div>
      </div>
      <div className="mt-10">
        <button
          ...
          `}
        >
          {t.jobDetails.formSection.submit}
        </button>
      </div>
      <p className="mt-4 text-sm/6 text-gray-500">
        {t.jobDetails.formSection.bySubmittingThisFormIAgreeToThe}&nbsp;
        <a
