    ...
    >
      <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        <div>
          ...
          >
            {t.contactUs.formSection.firstName}{" "}
        ...
        <div>
          <label
            ...
            className="block text-sm/6 font-semibold text-gray-900"
          >
            {t.contactUs.formSection.lastName}{" "}
            <span className="text-red-600">*</span>
          </label>
          <div className="mt-2.5">
            <input
        ...
        <div>
          <label
            ...
            className="block text-sm/6 font-semibold text-gray-900"
          >
            {t.contactUs.formSection.workEmail}{" "}
            <span className="text-red-600">*</span>
          </label>
          <div className="mt-2.5">
            <input
        ...
        <div>
          <label
            ...
            className="block text-sm/6 font-semibold text-gray-900"
          >
            {t.contactUs.formSection.workPhone}
          </label>
          <div className="mt-2.5">
            <input
              type="tel"
        ...
        <div className="sm:col-span-2">
          <label
            ...
            className="block text-sm/6 font-semibold text-gray-900"
          >
            {t.contactUs.formSection.company}
          </label>
          <div className="mt-2.5">
            <input
              type="text"
        ...
        <div className="sm:col-span-2">
          <label
            ...
            className="block text-sm/6 font-semibold text-gray-900"
          >
            {t.contactUs.formSection.message}{" "}
            <span className="text-red-600">*</span>
          </label>
          <div className="mt-2.5">
            <textarea
